...
<div class="menu" id="catalog-menu">
    <div class="menu__list">
        <a href="{{ route('catalog.index') }}" class="menu__list-item reset">
            Все категории
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M7.035 14.25L11.033 9.586a1 1 0 0 0 0-1.172L7.035 3.75" stroke="#2B308B" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
        </a>
                    ...
                    <a href="{{ route('category.show', $category->slug) }}"
                       ...
                       data-id="{{ $cat->slug }}">
                        ...
                        <div class="menu__item-img">
                            <img
                                src="{{ $category->image_url ?? $cat->image_url ?? asset('img/item-1.png') }}"
                                alt="{{ $category->name }}">
                        </div>
                    </a>
                @endforeach
