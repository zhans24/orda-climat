                ...
                <div class="category__items">
                    @forelse($products as $product)
                        <div class="category__item js-product"
                             ...
                             data-product-src="{{ $product->getFirstMediaUrl('cover', 'webp') ?: asset('img/item-1.png') }}"
                             data-product-quantity="1"
                             data-montage="0">

                            <div class="category__item-img">
                                <img src="{{ $product->getFirstMediaUrl('cover', 'webp') ?: asset('img/cat-1.png') }}"
                                     alt="{{ $product->name }}">
                            ...
                            <div class="category__item-block">
                                ...
                                <a href="{{ route('product.show', $product->slug) }}"
                                   class="category__item-link">{{ $product->name }}</a>
                            </div>
                        </div>
                    @empty
